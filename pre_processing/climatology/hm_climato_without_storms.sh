...
#SBATCH --job-name hm_clim_no_storms
...
python3 /work/FAC/FGSE/IDYST/tbeucler/default/fabien/repos/cleaner_version/util/climatology/hm_clim_without_storms.py "$month" "$day"
